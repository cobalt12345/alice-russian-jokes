exports.i18n = {
    ru_RU: {
        ...
        MSG_HELP: {
            text: () => `Я знаю кучу анекдотов, афоризмов и даже, анекдоты для взрослых! Чего изволите?`,
            tts: () => `Я знаю кучу анекдотов, афоризмов и даже, анекдоты для взрослых! Чего изволите?`
        }
    }
}
